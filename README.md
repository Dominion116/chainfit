...
A modern React e-commerce frontend for ChainFit that connects to Ethereum smart contracts, featuring product catalog, shopping cart, checkout with Reown AppKit (WalletConnect) integration, user dashboard, and admin panel.

## Features

- 🛍️ **Product Catalog** - Browse products with category filtering (shirts, trousers, shoes)
- 🛒 **Shopping Cart** - Add/remove items, update quantities, persistent cart storage
- 💳 **Checkout** - Reown AppKit integration for blockchain payments (supports MetaMask, WalletConnect, Coinbase Wallet, and more)
...
- **Reown AppKit** (formerly WalletConnect) - Wallet connection and Web3 integration
- **wagmi** + **viem** - Web3 contract interactions
...
5. **Checkout**: Connect your wallet using Reown AppKit and proceed to checkout
6. **Place Order**: Confirm the transaction in your wallet
...
- `VITE_REOWN_PROJECT_ID` - Your Reown AppKit Project ID (get one at [cloud.reown.com](https://cloud.reown.com))
